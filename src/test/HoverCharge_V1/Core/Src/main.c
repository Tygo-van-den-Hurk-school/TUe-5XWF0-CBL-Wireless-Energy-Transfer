...
/* USER CODE BEGIN PV */
uint8_t TxStartMessage[] = "/r/n***** Group 1 - HoverCharge - 5XWF0 *****/r/n";

//ADC
uint32_t ADC1_Buff[3];
uint32_t ADC2_Buff[2];
...
uint32_t adc_val_5;
float I_DCAC_OUT=0.0f;
//PWM
uint32_t PWM_Freq = 100000;
float PWM_DutyC_DCDC = 25;
float PWM_DutyC_DCAC = 75;
int32_t PWM_Period;
